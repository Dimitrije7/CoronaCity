...
public class OdraslaOsoba extends Osoba{
    ...
    public OdraslaOsoba(String ime, String prezime, String pol, int godinaRodjenja, int id, int idKuce, Tacka pozicija,float rKomp,float gKomp,float bKomp) {
    ...
    public void napraviRadius(){
        ...
        int radius=(int) Math.round((double)Parametri.VELICINA_MAPE*25/100);
    ...
    public static void napraviOdrasleOsobe(int brojOdraslih){
        ...
        for(int i=0;i<brojOdraslih;++i){
            OdraslaOsoba d=new OdraslaOsoba();
            d.setIme("odrasli"+i);
            d.setPrezime("prezime"+i);
            d.setPol(pol);
            d.setGodinaRodjenja(godiste+rand.nextInt(45));
